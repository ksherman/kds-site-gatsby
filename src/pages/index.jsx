...
export default () => (
  <div className="homepage-wrapper">
    <h1>Hey there!</h1>
    <p>I'm Kevin Sherman, a full-stack developer with a particular passion for front-end javascript frameworks. I love working in VueJS, but have also shipped code in React, Laravel, Ruby on Rails, Angular, and NodeJS. In 2015 I completed an MBA, and after working in higher education for almost 10 years, I left to joing a start-up building the front-end of a web application serving the concrete/construction industry.</p>
